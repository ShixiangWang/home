...
- Genomic analysis. I can process raw genomic data and analyze them. I have moderate experience in somatic variant calling (including SNV, INDEL and CNV).
...
Total citations: 70. (Data source: [Google Scholar](https://scholar.google.com/citations?user=FvNp0NkAAAAJ). Update time: `r Sys.Date()`)
